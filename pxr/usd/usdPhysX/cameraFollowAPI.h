...
//
#ifndef USDPHYSX_GENERATED_CAMERAFOLLOWAPI_H
#define USDPHYSX_GENERATED_CAMERAFOLLOWAPI_H

/// \file usdPhysX/cameraFollowAPI.h
...
/// \class UsdPhysXCameraFollowAPI
///
/// PhysX camera that follows behind the subject as it moves.
///
class UsdPhysXCameraFollowAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXCameraFollowAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXCameraFollowAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXCameraFollowAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXCameraFollowAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXCameraFollowAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXCameraFollowAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDPHYSX_API
    virtual ~UsdPhysXCameraFollowAPI();
    ...
    /// Return a UsdPhysXCameraFollowAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXCameraFollowAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXCameraFollowAPI
    ...
    /// 
    /// \return A valid UsdPhysXCameraFollowAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXCameraFollowAPI object is returned upon 
