...
static UsdAttribute
_CreateSpeedResponsesAttr(UsdPhysXVehicleNonlinearCommandResponseAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateSpeedResponsesPerCommandValueAttr(UsdPhysXVehicleNonlinearCommandResponseAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
{
    UsdPhysXVehicleNonlinearCommandResponseAPI_CanApplyResult(bool val, std::string const &msg) :
...
void wrapUsdPhysXVehicleNonlinearCommandResponseAPI()
{
    typedef UsdPhysXVehicleNonlinearCommandResponseAPI This;

    UsdPhysXVehicleNonlinearCommandResponseAPI_CanApplyResult::Wrap<UsdPhysXVehicleNonlinearCommandResponseAPI_CanApplyResult>(
