...
static UsdAttribute
_CreateDownHillGroundAngleAttr(UsdPhysXCameraFollowLookAPI &self,
...
static UsdAttribute
_CreateDownHillGroundPitchAttr(UsdPhysXCameraFollowLookAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateFollowReverseDistanceAttr(UsdPhysXCameraFollowLookAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateFollowReverseSpeedAttr(UsdPhysXCameraFollowLookAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateUpHillGroundAngleAttr(UsdPhysXCameraFollowLookAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateUpHillGroundPitchAttr(UsdPhysXCameraFollowLookAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateVelocityBlendTimeConstantAttr(UsdPhysXCameraFollowLookAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static std::string
_Repr(const UsdPhysXCameraFollowLookAPI &self)
{
    std::string primRepr = TfPyRepr(self.GetPrim());
    return TfStringPrintf(
        "UsdPhysX.CameraFollowLookAPI(%s)",
        primRepr.c_str());
}

struct UsdPhysXCameraFollowLookAPI_CanApplyResult : 
    public TfPyAnnotatedBoolResult<std::string>
{
    UsdPhysXCameraFollowLookAPI_CanApplyResult(bool val, std::string const &msg) :
        TfPyAnnotatedBoolResult<std::string>(val, msg) {}
};

static UsdPhysXCameraFollowLookAPI_CanApplyResult
_WrapCanApply(const UsdPrim& prim)
{
    std::string whyNot;
    bool result = UsdPhysXCameraFollowLookAPI::CanApply(prim, &whyNot);
    return UsdPhysXCameraFollowLookAPI_CanApplyResult(result, whyNot);
}

} // anonymous namespace

void wrapUsdPhysXCameraFollowLookAPI()
{
    typedef UsdPhysXCameraFollowLookAPI This;

    UsdPhysXCameraFollowLookAPI_CanApplyResult::Wrap<UsdPhysXCameraFollowLookAPI_CanApplyResult>(
        "_CanApplyResult", "whyNot");

    class_<This, bases<UsdAPISchemaBase> >
        cls("CameraFollowLookAPI");
