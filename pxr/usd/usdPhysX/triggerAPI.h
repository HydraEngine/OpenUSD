...
//
#ifndef USDPHYSX_GENERATED_TRIGGERAPI_H
#define USDPHYSX_GENERATED_TRIGGERAPI_H

/// \file usdPhysX/triggerAPI.h
...
/// as the value.
///
class UsdPhysXTriggerAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXTriggerAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXTriggerAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXTriggerAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXTriggerAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXTriggerAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXTriggerAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Return a UsdPhysXTriggerAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXTriggerAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXTriggerAPI
    ...
    /// This information is stored by adding "PhysxSchemaPhysxTriggerAPI" to the 
    /// token-valued, listOp metadata \em apiSchemas on the prim.
    /// 
    /// \return A valid UsdPhysXTriggerAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXTriggerAPI object is returned upon 
...
public:
    ...
    /// Enter script type.
    /// 
    /// Script file tries to find a file on disc and execute.
    /// 
    ///
    /// | ||
    /// | -- | -- |
