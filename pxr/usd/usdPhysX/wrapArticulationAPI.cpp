...
static UsdAttribute
_CreateArticulationEnabledAttr(UsdPhysXArticulationAPI &self,
...
static UsdAttribute
_CreateEnabledSelfCollisionsAttr(UsdPhysXArticulationAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateSleepThresholdAttr(UsdPhysXArticulationAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateSolverPositionIterationCountAttr(UsdPhysXArticulationAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateSolverVelocityIterationCountAttr(UsdPhysXArticulationAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateStabilizationThresholdAttr(UsdPhysXArticulationAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static std::string
_Repr(const UsdPhysXArticulationAPI &self)
{
    std::string primRepr = TfPyRepr(self.GetPrim());
    return TfStringPrintf(
        "UsdPhysX.ArticulationAPI(%s)",
        primRepr.c_str());
}

struct UsdPhysXArticulationAPI_CanApplyResult : 
    public TfPyAnnotatedBoolResult<std::string>
{
    UsdPhysXArticulationAPI_CanApplyResult(bool val, std::string const &msg) :
        TfPyAnnotatedBoolResult<std::string>(val, msg) {}
};

static UsdPhysXArticulationAPI_CanApplyResult
_WrapCanApply(const UsdPrim& prim)
{
    std::string whyNot;
    bool result = UsdPhysXArticulationAPI::CanApply(prim, &whyNot);
    return UsdPhysXArticulationAPI_CanApplyResult(result, whyNot);
}

} // anonymous namespace

void wrapUsdPhysXArticulationAPI()
{
    typedef UsdPhysXArticulationAPI This;

    UsdPhysXArticulationAPI_CanApplyResult::Wrap<UsdPhysXArticulationAPI_CanApplyResult>(
