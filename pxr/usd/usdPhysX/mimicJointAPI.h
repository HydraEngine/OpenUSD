...
//
#ifndef USDPHYSX_GENERATED_MIMICJOINTAPI_H
#define USDPHYSX_GENERATED_MIMICJOINTAPI_H

/// \file usdPhysX/mimicJointAPI.h
...
/// as the value.
///
class UsdPhysXMimicJointAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXMimicJointAPI on UsdPrim \p prim with
    /// name \p name . Equivalent to
    /// UsdPhysXMimicJointAPI::Get(
    ///    prim.GetStage(),
    ...
    /// an invalid \p prim
    explicit UsdPhysXMimicJointAPI(
        const UsdPrim& prim=UsdPrim(), const TfToken &name=TfToken())
        : UsdAPISchemaBase(prim, /*instanceName*/ name)
    { }

    /// Construct a UsdPhysXMimicJointAPI on the prim held by \p schemaObj with
    /// name \p name.  Should be preferred over
    /// UsdPhysXMimicJointAPI(schemaObj.GetPrim(), name), as it preserves
    /// SchemaBase state.
    explicit UsdPhysXMimicJointAPI(
    ...
    /// Return a UsdPhysXMimicJointAPI holding the prim adhering to this
    ...
    ///
    USDPHYSX_API
    static UsdPhysXMimicJointAPI
    Get(const UsdStagePtr &stage, const SdfPath &path);

    /// Return a UsdPhysXMimicJointAPI with name \p name holding the
    /// prim \p prim. Shorthand for UsdPhysXMimicJointAPI(prim, name);
    USDPHYSX_API
    static UsdPhysXMimicJointAPI
    Get(const UsdPrim &prim, const TfToken &name);

    /// Return a vector of all named instances of UsdPhysXMimicJointAPI on the 
    /// given \p prim.
    USDPHYSX_API
    static std::vector<UsdPhysXMimicJointAPI>
    ...
    /// 
    /// \return A valid UsdPhysXMimicJointAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXMimicJointAPI object is returned upon 
