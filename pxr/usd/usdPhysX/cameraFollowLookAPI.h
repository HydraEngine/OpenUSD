...
//
#ifndef USDPHYSX_GENERATED_CAMERAFOLLOWLOOKAPI_H
#define USDPHYSX_GENERATED_CAMERAFOLLOWLOOKAPI_H

/// \file usdPhysX/cameraFollowLookAPI.h
...
/// \class UsdPhysXCameraFollowLookAPI
///
...
///
class UsdPhysXCameraFollowLookAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXCameraFollowLookAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXCameraFollowLookAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXCameraFollowLookAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXCameraFollowLookAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXCameraFollowLookAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXCameraFollowLookAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDPHYSX_API
    virtual ~UsdPhysXCameraFollowLookAPI();
    ...
    /// Return a UsdPhysXCameraFollowLookAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXCameraFollowLookAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXCameraFollowLookAPI
    ...
    /// 
    /// \return A valid UsdPhysXCameraFollowLookAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXCameraFollowLookAPI object is returned upon 
