...
//
#ifndef USDPHYSX_GENERATED_CAMERADRONEAPI_H
#define USDPHYSX_GENERATED_CAMERADRONEAPI_H

/// \file usdPhysX/cameraDroneAPI.h
...
/// \class UsdPhysXCameraDroneAPI
///
/// PhysX drone camera that follows its subject from the air as it drives.
///
class UsdPhysXCameraDroneAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXCameraDroneAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXCameraDroneAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXCameraDroneAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXCameraDroneAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXCameraDroneAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXCameraDroneAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDPHYSX_API
    virtual ~UsdPhysXCameraDroneAPI();
    ...
    /// Return a UsdPhysXCameraDroneAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXCameraDroneAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXCameraDroneAPI
    ...
    /// 
    /// \return A valid UsdPhysXCameraDroneAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXCameraDroneAPI object is returned upon 
