...
//
#ifndef USDPHYSX_GENERATED_JOINTAPI_H
#define USDPHYSX_GENERATED_JOINTAPI_H

/// \file usdPhysX/jointAPI.h
...
/// \class UsdPhysXJointAPI
///
/// PhysX joint extended parameters.
///
class UsdPhysXJointAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXJointAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXJointAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXJointAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXJointAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXJointAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXJointAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Return a UsdPhysXJointAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXJointAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXJointAPI
    ...
    /// 
    /// \return A valid UsdPhysXJointAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXJointAPI object is returned upon 
