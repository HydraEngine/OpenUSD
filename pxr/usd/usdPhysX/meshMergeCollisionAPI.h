...
//
#ifndef USDPHYSX_GENERATED_MESHMERGECOLLISIONAPI_H
#define USDPHYSX_GENERATED_MESHMERGECOLLISIONAPI_H

/// \file usdPhysX/meshMergeCollisionAPI.h
...
/// \class UsdPhysXMeshMergeCollisionAPI
///
...
/// 
///
class UsdPhysXMeshMergeCollisionAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXMeshMergeCollisionAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXMeshMergeCollisionAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXMeshMergeCollisionAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXMeshMergeCollisionAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXMeshMergeCollisionAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXMeshMergeCollisionAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDPHYSX_API
    virtual ~UsdPhysXMeshMergeCollisionAPI();
    ...
    /// Return a UsdPhysXMeshMergeCollisionAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXMeshMergeCollisionAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXMeshMergeCollisionAPI
    ...
    /// 
    /// \return A valid UsdPhysXMeshMergeCollisionAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXMeshMergeCollisionAPI object is returned upon 
