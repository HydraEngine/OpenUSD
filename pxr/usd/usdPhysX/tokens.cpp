...
UsdPhysXTokensType::UsdPhysXTokensType() :
    ...
    commandValues("commandValues", TfToken::Immortal),
    ...
    maxBrakeTorque("maxBrakeTorque", TfToken::Immortal),
    ...
    speedResponses("speedResponses", TfToken::Immortal),
    speedResponsesPerCommandValue("speedResponsesPerCommandValue", TfToken::Immortal),
    ...
    torqueMultipliers("torqueMultipliers", TfToken::Immortal),
    ...
    wheels("wheels", TfToken::Immortal),
