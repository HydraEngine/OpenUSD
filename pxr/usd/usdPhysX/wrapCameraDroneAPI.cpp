...
static UsdAttribute
_CreateFeedForwardVelocityGainAttr(UsdPhysXCameraDroneAPI &self,
...
static UsdAttribute
_CreateFollowDistanceAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateFollowHeightAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateHorizontalVelocityGainAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateMaxDistanceAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateMaxSpeedAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreatePositionOffsetAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateRotationFilterTimeConstantAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateVelocityFilterTimeConstantAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static UsdAttribute
_CreateVerticalVelocityGainAttr(UsdPhysXCameraDroneAPI &self,
                                      object defaultVal, bool writeSparsely) {
...
static std::string
_Repr(const UsdPhysXCameraDroneAPI &self)
{
    std::string primRepr = TfPyRepr(self.GetPrim());
    return TfStringPrintf(
        "UsdPhysX.CameraDroneAPI(%s)",
        primRepr.c_str());
}

struct UsdPhysXCameraDroneAPI_CanApplyResult : 
    public TfPyAnnotatedBoolResult<std::string>
{
    UsdPhysXCameraDroneAPI_CanApplyResult(bool val, std::string const &msg) :
        TfPyAnnotatedBoolResult<std::string>(val, msg) {}
};

static UsdPhysXCameraDroneAPI_CanApplyResult
_WrapCanApply(const UsdPrim& prim)
{
    std::string whyNot;
    bool result = UsdPhysXCameraDroneAPI::CanApply(prim, &whyNot);
    return UsdPhysXCameraDroneAPI_CanApplyResult(result, whyNot);
}

} // anonymous namespace

void wrapUsdPhysXCameraDroneAPI()
{
    typedef UsdPhysXCameraDroneAPI This;

    UsdPhysXCameraDroneAPI_CanApplyResult::Wrap<UsdPhysXCameraDroneAPI_CanApplyResult>(
