...
//
#ifndef USDPHYSX_GENERATED_CONVEXDECOMPOSITIONCOLLISIONAPI_H
#define USDPHYSX_GENERATED_CONVEXDECOMPOSITIONCOLLISIONAPI_H

/// \file usdPhysX/convexDecompositionCollisionAPI.h
...
/// \class UsdPhysXConvexDecompositionCollisionAPI
///
/// PhysX convex decomposition(VHACD) extended parameters.
///
class UsdPhysXConvexDecompositionCollisionAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXConvexDecompositionCollisionAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXConvexDecompositionCollisionAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXConvexDecompositionCollisionAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXConvexDecompositionCollisionAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXConvexDecompositionCollisionAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXConvexDecompositionCollisionAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDPHYSX_API
    virtual ~UsdPhysXConvexDecompositionCollisionAPI();
    ...
    /// Return a UsdPhysXConvexDecompositionCollisionAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXConvexDecompositionCollisionAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXConvexDecompositionCollisionAPI
    ...
    /// 
    /// \return A valid UsdPhysXConvexDecompositionCollisionAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXConvexDecompositionCollisionAPI object is returned upon 
