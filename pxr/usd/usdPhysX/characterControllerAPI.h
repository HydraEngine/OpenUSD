...
//
#ifndef USDPHYSX_GENERATED_CHARACTERCONTROLLERAPI_H
#define USDPHYSX_GENERATED_CHARACTERCONTROLLERAPI_H

/// \file usdPhysX/characterControllerAPI.h
...
/// \class UsdPhysXCharacterControllerAPI
///
...
/// as the value.
///
class UsdPhysXCharacterControllerAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXCharacterControllerAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXCharacterControllerAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXCharacterControllerAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXCharacterControllerAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXCharacterControllerAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXCharacterControllerAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDPHYSX_API
    virtual ~UsdPhysXCharacterControllerAPI();
    ...
    /// Return a UsdPhysXCharacterControllerAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXCharacterControllerAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXCharacterControllerAPI
    ...
    /// 
    /// \return A valid UsdPhysXCharacterControllerAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXCharacterControllerAPI object is returned upon 
