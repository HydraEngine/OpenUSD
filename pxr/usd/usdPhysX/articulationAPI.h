...
//
#ifndef USDPHYSX_GENERATED_ARTICULATIONAPI_H
#define USDPHYSX_GENERATED_ARTICULATIONAPI_H

/// \file usdPhysX/articulationAPI.h
...
/// \class UsdPhysXArticulationAPI
///
/// PhysX articulation extended parameters.
///
class UsdPhysXArticulationAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXArticulationAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXArticulationAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXArticulationAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXArticulationAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXArticulationAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXArticulationAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDPHYSX_API
    virtual ~UsdPhysXArticulationAPI();
    ...
    /// Return a UsdPhysXArticulationAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXArticulationAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXArticulationAPI
    ...
    /// 
    /// \return A valid UsdPhysXArticulationAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXArticulationAPI object is returned upon 
