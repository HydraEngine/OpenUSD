...
void wrapUsdPhysXTokens()
{
    ...
    _ADD_TOKEN(cls, vehicleBrakes);
    _ADD_TOKEN(cls, vehicleBrakes_MultipleApplyTemplate_MaxBrakeTorque);
    _ADD_TOKEN(cls, vehicleBrakes_MultipleApplyTemplate_TorqueMultipliers);
    _ADD_TOKEN(cls, vehicleBrakes_MultipleApplyTemplate_Wheels);
    _ADD_TOKEN(cls, vehicleNonlinearCommandResponse);
    _ADD_TOKEN(cls, vehicleNonlinearCommandResponse_MultipleApplyTemplate_CommandValues);
    _ADD_TOKEN(cls, vehicleNonlinearCommandResponse_MultipleApplyTemplate_SpeedResponses);
    _ADD_TOKEN(cls, vehicleNonlinearCommandResponse_MultipleApplyTemplate_SpeedResponsesPerCommandValue);
    _ADD_TOKEN(cls, velocityChange);
    _ADD_TOKEN(cls, wheel);
    _ADD_TOKEN(cls, X);
    _ADD_TOKEN(cls, Y);
    _ADD_TOKEN(cls, Z);
    ...
    _ADD_TOKEN(cls, PhysxSchemaPhysxVehicleTankControllerAPI);
    _ADD_TOKEN(cls, PhysxSchemaPhysxVehicleTankDifferentialAPI);
    _ADD_TOKEN(cls, PhysxSchemaPhysxVehicleTireAPI);
    _ADD_TOKEN(cls, PhysxSchemaPhysxVehicleTireFrictionTable);
    _ADD_TOKEN(cls, PhysxSchemaPhysxVehicleWheelAPI);
    _ADD_TOKEN(cls, PhysxSchemaPhysxVehicleWheelAttachmentAPI);
    _ADD_TOKEN(cls, PhysxSchemaPhysxVehicleWheelControllerAPI);
}
