...
//
#ifndef USDPHYSX_GENERATED_COLLISIONAPI_H
#define USDPHYSX_GENERATED_COLLISIONAPI_H

/// \file usdPhysX/collisionAPI.h
...
/// \class UsdPhysXCollisionAPI
///
/// PhysX collision extended parameters.
///
class UsdPhysXCollisionAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdPhysXCollisionAPI on UsdPrim \p prim .
    /// Equivalent to UsdPhysXCollisionAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdPhysXCollisionAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdPhysXCollisionAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdPhysXCollisionAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdPhysXCollisionAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Return a UsdPhysXCollisionAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdPhysXCollisionAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDPHYSX_API
    static UsdPhysXCollisionAPI
    ...
    /// 
    /// \return A valid UsdPhysXCollisionAPI object is returned upon success. 
    /// An invalid (or empty) UsdPhysXCollisionAPI object is returned upon 
