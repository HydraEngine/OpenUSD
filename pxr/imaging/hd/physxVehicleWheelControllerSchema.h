...
#ifndef PXR_IMAGING_HD_PHYSX_VEHICLE_WHEEL_CONTROLLER_SCHEMA_H
#define PXR_IMAGING_HD_PHYSX_VEHICLE_WHEEL_CONTROLLER_SCHEMA_H
...
#define HD_PHYSX_VEHICLE_WHEEL_CONTROLLER_SCHEMA_TOKENS \
    (physxVehicleWheelController) \
    (brakeTorque) \
    (driveTorque) \
    (steerAngle) \

TF_DECLARE_PUBLIC_TOKENS(HdPhysxVehicleWheelControllerSchemaTokens, HD_API,
    HD_PHYSX_VEHICLE_WHEEL_CONTROLLER_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------


class HdPhysxVehicleWheelControllerSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    HdPhysxVehicleWheelControllerSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxVehicleWheelController" from the parent container and constructs a
    /// HdPhysxVehicleWheelControllerSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    HD_API
    static HdPhysxVehicleWheelControllerSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class HdPhysxVehicleWheelControllerSchema::Builder
    /// 
