...
#ifndef PXR_IMAGING_HD_PHYSX_COOKED_DATA_SCHEMA_H
#define PXR_IMAGING_HD_PHYSX_COOKED_DATA_SCHEMA_H
...
class HdPhysxCookedDataSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    HdPhysxCookedDataSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxCookedData" from the parent container and constructs a
    /// HdPhysxCookedDataSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    HD_API
    static HdPhysxCookedDataSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class HdPhysxCookedDataSchema::Builder
    /// 
