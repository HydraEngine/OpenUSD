...
#ifndef PXR_IMAGING_HD_PHYSX_PHYSICS_RACK_AND_PINION_JOINT_SCHEMA_H
#define PXR_IMAGING_HD_PHYSX_PHYSICS_RACK_AND_PINION_JOINT_SCHEMA_H
...
#define HD_PHYSX_PHYSICS_RACK_AND_PINION_JOINT_SCHEMA_TOKENS \
    (physxPhysicsRackAndPinionJoint) \
    (ratio) \
    (hinge) \
    (prismatic) \

TF_DECLARE_PUBLIC_TOKENS(HdPhysxPhysicsRackAndPinionJointSchemaTokens, HD_API,
    HD_PHYSX_PHYSICS_RACK_AND_PINION_JOINT_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------


class HdPhysxPhysicsRackAndPinionJointSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    HdPhysxPhysicsRackAndPinionJointSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxPhysicsRackAndPinionJoint" from the parent container and constructs a
    /// HdPhysxPhysicsRackAndPinionJointSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    HD_API
    static HdPhysxPhysicsRackAndPinionJointSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class HdPhysxPhysicsRackAndPinionJointSchema::Builder
    /// 
