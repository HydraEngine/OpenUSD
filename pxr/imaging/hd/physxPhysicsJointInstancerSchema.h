...
#ifndef PXR_IMAGING_HD_PHYSX_PHYSICS_JOINT_INSTANCER_SCHEMA_H
#define PXR_IMAGING_HD_PHYSX_PHYSICS_JOINT_INSTANCER_SCHEMA_H
...
#define HD_PHYSX_PHYSICS_JOINT_INSTANCER_SCHEMA_TOKENS \
...
TF_DECLARE_PUBLIC_TOKENS(HdPhysxPhysicsJointInstancerSchemaTokens, HD_API,
    HD_PHYSX_PHYSICS_JOINT_INSTANCER_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------


class HdPhysxPhysicsJointInstancerSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    HdPhysxPhysicsJointInstancerSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxPhysicsJointInstancer" from the parent container and constructs a
    /// HdPhysxPhysicsJointInstancerSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    HD_API
    static HdPhysxPhysicsJointInstancerSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class HdPhysxPhysicsJointInstancerSchema::Builder
    /// 
