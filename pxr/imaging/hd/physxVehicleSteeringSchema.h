...
#ifndef PXR_IMAGING_HD_PHYSX_VEHICLE_STEERING_SCHEMA_H
#define PXR_IMAGING_HD_PHYSX_VEHICLE_STEERING_SCHEMA_H
...
#define HD_PHYSX_VEHICLE_STEERING_SCHEMA_TOKENS \
    (physxVehicleSteering) \
    (angleMultipliers) \
    (maxSteerAngle) \
    (wheels) \

TF_DECLARE_PUBLIC_TOKENS(HdPhysxVehicleSteeringSchemaTokens, HD_API,
    HD_PHYSX_VEHICLE_STEERING_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------


class HdPhysxVehicleSteeringSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    HdPhysxVehicleSteeringSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxVehicleSteering" from the parent container and constructs a
    /// HdPhysxVehicleSteeringSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    HD_API
    static HdPhysxVehicleSteeringSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class HdPhysxVehicleSteeringSchema::Builder
    /// 
