...
#ifndef PXR_IMAGING_FABRIC_PHYSX_VEHICLE_ENGINE_SCHEMA_H
#define PXR_IMAGING_FABRIC_PHYSX_VEHICLE_ENGINE_SCHEMA_H
...
#define FABRIC_PHYSX_VEHICLE_ENGINE_SCHEMA_TOKENS \
    (physxVehicleEngine) \
...
TF_DECLARE_PUBLIC_TOKENS(FabricPhysxVehicleEngineSchemaTokens, FABRIC_API,
    FABRIC_PHYSX_VEHICLE_ENGINE_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------


class FabricPhysxVehicleEngineSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    FabricPhysxVehicleEngineSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxVehicleEngine" from the parent container and constructs a
    /// FabricPhysxVehicleEngineSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    FABRIC_API
    static FabricPhysxVehicleEngineSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class FabricPhysxVehicleEngineSchema::Builder
    /// 
