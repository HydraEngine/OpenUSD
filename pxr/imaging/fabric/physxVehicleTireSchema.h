...
#ifndef PXR_IMAGING_FABRIC_PHYSX_VEHICLE_TIRE_SCHEMA_H
#define PXR_IMAGING_FABRIC_PHYSX_VEHICLE_TIRE_SCHEMA_H
...
#define FABRIC_PHYSX_VEHICLE_TIRE_SCHEMA_TOKENS \
    (physxVehicleTire) \
    (camberStiffness) \
    (frictionVsSlipGraph) \
...
TF_DECLARE_PUBLIC_TOKENS(FabricPhysxVehicleTireSchemaTokens, FABRIC_API,
    FABRIC_PHYSX_VEHICLE_TIRE_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------


class FabricPhysxVehicleTireSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    FabricPhysxVehicleTireSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxVehicleTire" from the parent container and constructs a
    /// FabricPhysxVehicleTireSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    FABRIC_API
    static FabricPhysxVehicleTireSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class FabricPhysxVehicleTireSchema::Builder
    /// 
