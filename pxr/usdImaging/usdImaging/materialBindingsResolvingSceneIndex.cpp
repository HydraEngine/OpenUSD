...
bool _HasDirectOrCollectionMaterialBindings(const HdContainerDataSourceHandle &c) {
    return HdDirectMaterialBindingsSchema::GetFromParent(c) ||
...
public:
    ...
    HdDataSourceBaseHandle Get(const TfToken &name) override {
        ...
        HdDirectMaterialBindingsSchema dirBindingsSchema =
                HdDirectMaterialBindingsSchema::GetFromParent(_primContainer);

        HdDirectMaterialBindingSchema dirBindingSchema = dirBindingsSchema.GetDirectMaterialBinding(purpose);
...
public:
    ...
    TfTokenVector GetNames() override { return _meshContainer->GetNames(); }
...
UsdImagingMaterialBindingsResolvingSceneIndexRefPtr UsdImagingMaterialBindingsResolvingSceneIndex::New(
        const HdSceneIndexBaseRefPtr &inputSceneIndex, const HdContainerDataSourceHandle &inputArgs) {
    return TfCreateRefPtr(new UsdImagingMaterialBindingsResolvingSceneIndex(inputSceneIndex, inputArgs));
}
...
UsdImagingMaterialBindingsResolvingSceneIndex::~UsdImagingMaterialBindingsResolvingSceneIndex() = default;

HdSceneIndexPrim UsdImagingMaterialBindingsResolvingSceneIndex::GetPrim(const SdfPath &primPath) const {
    TRACE_FUNCTION();
...
SdfPathVector UsdImagingMaterialBindingsResolvingSceneIndex::GetChildPrimPaths(const SdfPath &primPath) const {
    // This scene index does not mutate the topology.
    return _GetInputSceneIndex()->GetChildPrimPaths(primPath);
}

void UsdImagingMaterialBindingsResolvingSceneIndex::_PrimsAdded(const HdSceneIndexBase &sender,
...
void UsdImagingMaterialBindingsResolvingSceneIndex::_PrimsDirtied(
    ...
    for (auto const &entry : entries) {
        if (entry.dirtyLocators.Intersects(usdMaterialBindingLocators)) {
            ...
            newLocators = newLocators.ReplacePrefix(HdDirectMaterialBindingsSchema::GetDefaultLocator(),
                                                    HdMaterialBindingsSchema::GetDefaultLocator());
            newLocators = newLocators.ReplacePrefix(UsdImagingCollectionMaterialBindingsSchema::GetDefaultLocator(),
                                                    HdMaterialBindingsSchema::GetDefaultLocator());
