...
/// \class UsdImagingPhysicsSphericalJointAdapter
///
/// Adapter support for UsdPhysicsSphericalJoint for *only* the scene index (2.0) API.
///
...
///       products and vars.
///
class  UsdImagingPhysicsSphericalJointAdapter: public UsdImagingPhysicsJointAdapter {
public:
    using BaseAdapter = UsdImagingPrimAdapter;

    UsdImagingPhysicsSphericalJointAdapter() : UsdImagingPhysicsJointAdapter() {}

    USDPHYSICSIMAGING_API
    ~UsdImagingPhysicsSphericalJointAdapter() override;
