...
/// \class UsdImagingPhysicsSceneAdapter
///
/// Adapter support for UsdPhysicsScene for *only* the scene index (2.0) API.
///
...
///       products and vars.
///
class UsdImagingPhysicsSceneAdapter : public UsdImagingPrimAdapter {
public:
    using BaseAdapter = UsdImagingPrimAdapter;

    UsdImagingPhysicsSceneAdapter() : UsdImagingPrimAdapter() {}

    USDPHYSICSIMAGING_API
    ~UsdImagingPhysicsSceneAdapter() override;
