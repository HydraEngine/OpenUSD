...
#ifndef PXR_USD_IMAGING_USD_PHYSICS_IMAGING_PHYSX_PHYSICS_RACK_AND_PINION_JOINT_SCHEMA_H
#define PXR_USD_IMAGING_USD_PHYSICS_IMAGING_PHYSX_PHYSICS_RACK_AND_PINION_JOINT_SCHEMA_H
...
class UsdPhysicsImagingPhysxPhysicsRackAndPinionJointSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    UsdPhysicsImagingPhysxPhysicsRackAndPinionJointSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxPhysicsRackAndPinionJoint" from the parent container and constructs a
    /// UsdPhysicsImagingPhysxPhysicsRackAndPinionJointSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    USDPHYSICSIMAGING_API
    static UsdPhysicsImagingPhysxPhysicsRackAndPinionJointSchema GetFromParent(
