...
#include "pxr/usdImaging/usdPhysicsImaging/physxVehicleSteeringAPIAdapter.h"
...
TF_REGISTRY_FUNCTION(TfType) {
    typedef UsdImagingPhysicsPhysXVehicleSteeringAPIAdapter Adapter;
...
private:
    UsdPhysXVehicleSteeringAPI _api;
};
}  // namespace

HdContainerDataSourceHandle UsdImagingPhysicsPhysXVehicleSteeringAPIAdapter::GetImagingSubprimData(
        UsdPrim const& prim,
...
HdDataSourceLocatorSet UsdImagingPhysicsPhysXVehicleSteeringAPIAdapter::InvalidateImagingSubprim(
        UsdPrim const& prim,
        TfToken const& subprim,
        TfToken const& appliedInstanceName,
