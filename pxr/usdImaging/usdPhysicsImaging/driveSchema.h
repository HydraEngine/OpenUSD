...
#ifndef PXR_USD_IMAGING_USD_PHYSICS_IMAGING_DRIVE_SCHEMA_H
#define PXR_USD_IMAGING_USD_PHYSICS_IMAGING_DRIVE_SCHEMA_H
...
#define USD_PHYSICS_IMAGING_DRIVE_SCHEMA_TOKENS \
    (drive) \
    (type) \
    (maxForce) \
    (targetPosition) \
...
TF_DECLARE_PUBLIC_TOKENS(UsdPhysicsImagingDriveSchemaTokens, USDPHYSICSIMAGING_API,
...
public:
    ...
    UsdPhysicsImagingDriveSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "drive" from the parent container and constructs a
    /// UsdPhysicsImagingDriveSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    USDPHYSICSIMAGING_API
    static UsdPhysicsImagingDriveSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class UsdPhysicsImagingDriveSchema::Builder
    /// 
