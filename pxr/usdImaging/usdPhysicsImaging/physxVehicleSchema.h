...
#ifndef PXR_USD_IMAGING_USD_PHYSICS_IMAGING_PHYSX_VEHICLE_SCHEMA_H
#define PXR_USD_IMAGING_USD_PHYSICS_IMAGING_PHYSX_VEHICLE_SCHEMA_H
...
#define USD_PHYSICS_IMAGING_PHYSX_VEHICLE_SCHEMA_TOKENS \
    (physxVehicle) \
...
TF_DECLARE_PUBLIC_TOKENS(UsdPhysicsImagingPhysxVehicleSchemaTokens, USDPHYSICSIMAGING_API,
    USD_PHYSICS_IMAGING_PHYSX_VEHICLE_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------


class UsdPhysicsImagingPhysxVehicleSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    UsdPhysicsImagingPhysxVehicleSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxVehicle" from the parent container and constructs a
    /// UsdPhysicsImagingPhysxVehicleSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    USDPHYSICSIMAGING_API
    static UsdPhysicsImagingPhysxVehicleSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class UsdPhysicsImagingPhysxVehicleSchema::Builder
    /// 
