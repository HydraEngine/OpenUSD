...
#ifndef PXR_USD_IMAGING_USD_PHYSICS_IMAGING_PHYSX_CAMERA_FOLLOW_SCHEMA_H
#define PXR_USD_IMAGING_USD_PHYSICS_IMAGING_PHYSX_CAMERA_FOLLOW_SCHEMA_H
...
#define USD_PHYSICS_IMAGING_PHYSX_CAMERA_FOLLOW_SCHEMA_TOKENS \
    (physxCameraFollow) \
...
TF_DECLARE_PUBLIC_TOKENS(UsdPhysicsImagingPhysxCameraFollowSchemaTokens, USDPHYSICSIMAGING_API,
    USD_PHYSICS_IMAGING_PHYSX_CAMERA_FOLLOW_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------


class UsdPhysicsImagingPhysxCameraFollowSchema : public HdSchema
{
public:
    /// \name Schema retrieval
    /// @{

    UsdPhysicsImagingPhysxCameraFollowSchema(HdContainerDataSourceHandle container)
      : HdSchema(container) {}

    /// Retrieves a container data source with the schema's default name token
    /// "physxCameraFollow" from the parent container and constructs a
    /// UsdPhysicsImagingPhysxCameraFollowSchema instance.
    /// Because the requested container data source may not exist, the result
    /// should be checked with IsDefined() or a bool comparison before use.
    USDPHYSICSIMAGING_API
    static UsdPhysicsImagingPhysxCameraFollowSchema GetFromParent(
...
// --(END CUSTOM CODE: Schema Methods)--
    ...
    /// \class UsdPhysicsImagingPhysxCameraFollowSchema::Builder
    /// 
