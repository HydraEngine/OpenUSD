...
/// \class UsdImagingPhysicsGearJointAdapter
///
/// Adapter support for UsdPhysicsGearJoint for *only* the scene index (2.0) API.
///
...
///       products and vars.
///
class  UsdImagingPhysicsGearJointAdapter: public UsdImagingPhysicsJointAdapter {
public:
    using BaseAdapter = UsdImagingPrimAdapter;

    UsdImagingPhysicsGearJointAdapter() : UsdImagingPhysicsJointAdapter() {}

    USDPHYSICSIMAGING_API
    ~UsdImagingPhysicsGearJointAdapter() override;
