...
#include "pxr/usdImaging/usdPhysicsImaging/physxTriangleMeshCollisionAPIAdapter.h"
...
TF_REGISTRY_FUNCTION(TfType) {
    typedef UsdImagingPhysicsPhysXTriangleMeshCollisionAPIAdapter Adapter;
...
private:
    UsdPhysXTriangleMeshCollisionAPI _api;
};
}  // namespace

HdContainerDataSourceHandle UsdImagingPhysicsPhysXTriangleMeshCollisionAPIAdapter::GetImagingSubprimData(
        UsdPrim const& prim,
...
HdDataSourceLocatorSet UsdImagingPhysicsPhysXTriangleMeshCollisionAPIAdapter::InvalidateImagingSubprim(
        UsdPrim const& prim,
        TfToken const& subprim,
        TfToken const& appliedInstanceName,
