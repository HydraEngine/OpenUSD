...
/// \class UsdImagingPhysicsPrismaticJointAdapter
///
/// Adapter support for UsdPhysicsPrismaticJoint for *only* the scene index (2.0) API.
///
...
///       products and vars.
///
class  UsdImagingPhysicsPrismaticJointAdapter: public UsdImagingPhysicsJointAdapter {
public:
    using BaseAdapter = UsdImagingPrimAdapter;

    UsdImagingPhysicsPrismaticJointAdapter() : UsdImagingPhysicsJointAdapter() {}

    USDPHYSICSIMAGING_API
    ~UsdImagingPhysicsPrismaticJointAdapter() override;
