...
/// \class UsdImagingPhysicsJointAdapter
///
/// Adapter support for UsdPhysicsJoint for *only* the scene index (2.0) API.
///
...
///       products and vars.
///
class UsdImagingPhysicsJointAdapter : public UsdImagingPrimAdapter {
public:
    using BaseAdapter = UsdImagingPrimAdapter;

    UsdImagingPhysicsJointAdapter() : UsdImagingPrimAdapter() {}

    USDPHYSICSIMAGING_API
    ~UsdImagingPhysicsJointAdapter() override;
