...
class UsdPhysicsImagingFilteredPairsSchema : public HdSchema {
public:
    ...
    static UsdPhysicsImagingFilteredPairsSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
