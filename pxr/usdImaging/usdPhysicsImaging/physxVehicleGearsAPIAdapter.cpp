...
#include "pxr/usdImaging/usdPhysicsImaging/physxVehicleGearsAPIAdapter.h"
...
TF_REGISTRY_FUNCTION(TfType) {
    typedef UsdImagingPhysicsPhysXVehicleGearsAPIAdapter Adapter;
...
private:
    UsdPhysXVehicleGearsAPI _api;
};
}  // namespace

HdContainerDataSourceHandle UsdImagingPhysicsPhysXVehicleGearsAPIAdapter::GetImagingSubprimData(
        UsdPrim const& prim,
...
HdDataSourceLocatorSet UsdImagingPhysicsPhysXVehicleGearsAPIAdapter::InvalidateImagingSubprim(
        UsdPrim const& prim,
        TfToken const& subprim,
        TfToken const& appliedInstanceName,
