...
/// \class UsdImagingPhysicsRevoluteJointAdapter
///
/// Adapter support for UsdPhysicsRevoluteJoint for *only* the scene index (2.0) API.
///
...
///       products and vars.
///
class  UsdImagingPhysicsRevoluteJointAdapter: public UsdImagingPhysicsJointAdapter {
public:
    using BaseAdapter = UsdImagingPrimAdapter;

    UsdImagingPhysicsRevoluteJointAdapter() : UsdImagingPhysicsJointAdapter() {}

    USDPHYSICSIMAGING_API
    ~UsdImagingPhysicsRevoluteJointAdapter() override;
