...
/// \class UsdImagingPhysicsCollisionGroupAdapter
///
/// Adapter support for UsdPhysicsCollisionGroup for *only* the scene index (2.0) API.
///
...
///       products and vars.
///
class UsdImagingPhysicsCollisionGroupAdapter : public UsdImagingPrimAdapter {
public:
    using BaseAdapter = UsdImagingPrimAdapter;

    UsdImagingPhysicsCollisionGroupAdapter() : UsdImagingPrimAdapter() {}

    USDPHYSICSIMAGING_API
    ~UsdImagingPhysicsCollisionGroupAdapter() override;
