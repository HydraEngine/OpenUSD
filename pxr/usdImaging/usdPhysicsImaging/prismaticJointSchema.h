...
class HdPrismaticJointSchema : public HdJointSchema {
public:
    /// \name Schema retrieval
    /// @{

    HdPrismaticJointSchema(HdContainerDataSourceHandle container) : HdJointSchema(container) {}
    ...
    HD_API
    static HdPrismaticJointSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
