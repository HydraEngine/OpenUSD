...
#define HD_PHYSICS_SCHEMA_TOKENS     \
    (physicsScene)(physicsMaterial)( \
            physicsArticulationRoot)(physicsCollision)(physicsMeshCollision)(physicsDrive)(physicsFilteredPairs)(physicsLimit)(physicsMass)(physicsRigidBody)(physicsJoint)(physicsDistanceJoint)
