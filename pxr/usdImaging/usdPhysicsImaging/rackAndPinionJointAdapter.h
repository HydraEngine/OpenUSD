...
/// \class UsdImagingPhysicsRackAndPinionJointAdapter
///
/// Adapter support for UsdPhysicsRackAndPinionJoint for *only* the scene index (2.0) API.
///
...
///       products and vars.
///
class  UsdImagingPhysicsRackAndPinionJointAdapter: public UsdImagingPhysicsJointAdapter {
public:
    using BaseAdapter = UsdImagingPrimAdapter;

    UsdImagingPhysicsRackAndPinionJointAdapter() : UsdImagingPhysicsJointAdapter() {}

    USDPHYSICSIMAGING_API
    ~UsdImagingPhysicsRackAndPinionJointAdapter() override;
