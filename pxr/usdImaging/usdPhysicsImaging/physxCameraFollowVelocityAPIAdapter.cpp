...
#include "pxr/usdImaging/usdPhysicsImaging/physxCameraFollowVelocityAPIAdapter.h"
...
TF_REGISTRY_FUNCTION(TfType) {
    typedef UsdImagingPhysicsPhysXCameraFollowVelocityAPIAdapter Adapter;
...
private:
    UsdPhysXCameraFollowVelocityAPI _api;
};
}  // namespace

HdContainerDataSourceHandle UsdImagingPhysicsPhysXCameraFollowVelocityAPIAdapter::GetImagingSubprimData(
        UsdPrim const& prim,
...
HdDataSourceLocatorSet UsdImagingPhysicsPhysXCameraFollowVelocityAPIAdapter::InvalidateImagingSubprim(
        UsdPrim const& prim,
        TfToken const& subprim,
        TfToken const& appliedInstanceName,
